...
@PostMapping("/token")
public ResponseEntity<?> generateToken(@RequestBody EmpLoginReq jwtRequest, HttpServletResponse response,
...
"jwt=" + token + "; Path=/dcm; HttpOnly; SameSite=None; Secure=false; Max-Age=86400");
...
java.util.function.Function<Object, String> safeString = obj -> obj != null ? obj.toString() : "";
...
//    return ResponseEntity.ok(new ApiResponse(true, "Login successful", responsePayload));
return ResponseEntity.ok(new ApiResponse<>(true, "Login successful", employeeDetails));
